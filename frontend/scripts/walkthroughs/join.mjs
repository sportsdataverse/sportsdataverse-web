...
// Also answers "yes" to the package question and fills the package fieldset (PR 3), so the
// evidence video shows those fields. Because the address is reserved, lib/join.ts's
// handleJoin skips submitPackage entirely — the person is stored with wants.package: true,
// but this obviously-fake package never reaches the member CMS queue.
