...
export default function CodeTitle({ title, lang }: Props) {
  ...
  return (
    <div className="relative !z-10">
      <div className="bg-[#21252b] text-gray-200  rounded-tl-md rounded-tr-md p-3  flex items-center justify-between font-mono !mt-4 overflow-x-scroll xs:overflow-auto border border-border  ">
