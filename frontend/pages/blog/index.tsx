  ...
  return (
    <>
      <Metadata
        ...
        previewImage={pageMeta.blog.image}
        keywords={pageMeta.blog.keywords}
      />

      <section className="pageTop flex flex-col gap-2">
        <PageTop pageTitle="Blog">
          We've been working on sports analytics and data packages since 2020, mostly in Python, R, and Node.js.
        </PageTop>
              ...
              <>
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <Link href="/blog/bookmark" legacyBehavior>
