---
title: '{worldfootballR} for Soccer'
date: '2021-10-21'
author:
  name: Saiem Gilani
  picture: '/blog/authors/saiemgilani.png'
tags: ['r', 'soccer', 'worldfootballR', 'sportsdataverse']
published: true
excerpt: 'Designed to allow users to extract various world football results and player statistics from popular football (soccer) data sites.'
image: '/blog/worldfootballR-for-soccer-data/cover.png'
ogImage:
  url: '/blog/worldfootballR-for-soccer-data/cover.png'
---
...
> **Status note:** As of **September 2025**, `worldfootballR` and its companion
> data repository are **no longer maintained** — the GitHub repository has been
> archived (read-only). It is no longer part of the core SportsDataverse roster.
> The package still installs from CRAN and the walkthrough below is preserved for
> historical reference, but expect scrapers to drift as the upstream sites change.
