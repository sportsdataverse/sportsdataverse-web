  ...
  return (
    <section className="mx-5 mb-5">
      ...
      <div className="grid grid-cols-1 gap-4 mx-auto">
        ...
        <Link
          href="/blog"
          className="flex items-center justify-center gap-1 font-medium transition border-transparent font-inter active:scale-95 active:border-foreground w-fit group md:ml-7"
        >
          Read all posts
          <svg
