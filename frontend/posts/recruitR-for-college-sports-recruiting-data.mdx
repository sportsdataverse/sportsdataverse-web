---
title: '{recruitR} for College Sports Recruiting'
date: '2021-10-21'
author:
  name: Saiem Gilani
...
published: true
excerpt: 'Pull 247Sports Composite recruiting rankings and recruit information into tidy R data frames via the CollegeFootballData API.'
image: '/blog/recruitR-for-college-sports-recruiting-data/cover.png'
ogImage:
  url: '/blog/recruitR-for-college-sports-recruiting-data/cover.png'
---
...
[![R-CMD-check](https://img.shields.io/github/actions/workflow/status/sportsdataverse/recruitR/R-CMD-check.yaml?branch=main&label=R-CMD-Check&logo=R&logoColor=white&style=for-the-badge)](https://github.com/sportsdataverse/recruitR/actions/workflows/R-CMD-check.yaml)
...
data. It gives you access to **247Sports Composite rankings** and recruit
information through the
[CollegeFootballData](https://collegefootballdata.com/) API, wrapping its
recruiting and roster endpoints into tidy data frames.
...
itself. Please report issues here or to [https://collegefootballdata.com/](https://collegefootballdata.com/).
