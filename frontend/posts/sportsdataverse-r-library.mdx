---
title: 'The {sportsdataverse} R-verse Package'
date: '2022-07-03'
author:
  name: Saiem Gilani
  picture: '/blog/authors/saiemgilani.png'
tags: ['r', 'mens-college-basketball', 'nba', 'womens-college-basketball', 'wnba', 'nfl', 'nhl', 'ncaa', 'sportsdataverse']
published: true
excerpt: 'The sportsdataverse is a set of sports data packages that work in harmony because they share common data representations and API design.
This package is designed to make it easy to install and load multiple sportsdataverse packages in a single step.'
image: '/blog/sportsdataverse-r-library/cover.png'
ogImage:
  url: '/blog/sportsdataverse-r-library/cover.png'
---
...
[**`sportsdataverse`**](https://r.sportsdataverse.org) is from the
[SportsDataverse r-universe](https://sportsdataverse.r-universe.dev/), which
serves prebuilt binaries of the development versions:
...
`library(sportsdataverse)` attaches the seven core SportsDataverse
...
It also ships quality-of-life helpers — `sportsdataverse_packages()` to
list the set, `sportsdataverse_update()` to check for updates, and
`sportsdataverse_sitrep()` to report the versions of R and every
...
[![CRAN
Status](https://img.shields.io/cran/v/oddsapiR?color=success&label=CRAN%20Version&logo=R&style=for-the-badge)](https://CRAN.R-project.org/package=oddsapiR)
[![CRAN
downloads](https://img.shields.io/badge/dynamic/json?style=for-the-badge&color=success&label=Downloads&query=%24%5B0%5D.downloads&url=https%3A%2F%2Fcranlogs.r-pkg.org%2Fdownloads%2Ftotal%2F2021-10-26%3Alast-day%2FoddsapiR)](https://CRAN.R-project.org/package=oddsapiR)
