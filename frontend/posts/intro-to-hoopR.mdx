---
slug: hoopr-for-mens-basketball
title: "{hoopR} for Men's Basketball"
date: '2022-05-08'
author:
  name: Saiem Gilani
  picture: '/blog/authors/saiemgilani.png'
tags: ['r', 'nba', 'mens-college-basketball', 'ncaa', 'hoopr', 'sportsdataverse']
published: true
excerpt: 'Retrieves NBA and mens college basketball data from ESPN, kenpom.com, and the NCAA website.'
image: '/blog/intro-to-hoopR/cover.png'
---
...
Stats API wrapper, exposing well over a hundred endpoints from
`stats.nba.com` alongside the ESPN and loader functions.
