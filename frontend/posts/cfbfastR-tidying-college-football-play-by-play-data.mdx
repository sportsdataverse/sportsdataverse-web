---
title: '{cfbfastR}: Tidying College Football Play-by-Play Data'
date: '2021-05-10'
author:
  name: Saiem Gilani
  picture: '/blog/authors/saiemgilani.png'
tags: ['r', 'college football', 'ncaa', 'cfbfastr', 'sportsdataverse']
published: true
excerpt: 'An R package to quickly obtain clean and tidy college football play by play data'
image: '/blog/cfbfastR-tidying-college-football-play-by-play-data/cover.png'
ogImage:
  url: '/blog/cfbfastR-tidying-college-football-play-by-play-data/cover.png'
---
...
is an R API wrapper around [https://collegefootballdata.com/](https://collegefootballdata.com/). Beyond
...
`getOption("cfbfastR.proxy")` → `http_proxy` / `https_proxy` environment
variables.
