...
export default function SnippetPage({
  ...
  const authorName = snippet.meta.author?.name  ? snippet.meta.author.name : "SportsDataverse Contributor";
  const authorPicture = snippet.meta.author?.picture ? snippet.meta.author.picture : homeProfileImage;
  return (
    <>
      <Metadata
