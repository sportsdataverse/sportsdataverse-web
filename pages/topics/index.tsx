...
const Topics = ({ topics, postsData }: { topics: string[]; postsData: PostData[] }): ReactElement => {
  return (
    <>
      <Head>
        <title>SportsDataverse Topics</title>
        <meta name="description" content={'SportsDataverse topics like ' + topics.slice(0, 5).join(', ') + ' and more'} />
      </Head>
      <PageHeading title="SportsDataverse topics" />
