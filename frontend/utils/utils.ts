...
export const AvatarImage: string = "https://avatars.githubusercontent.com/u/25425933?v=4";
export const homeProfileImage: string = "https://avatars.githubusercontent.com/u/65556153?s=200&v=4";
