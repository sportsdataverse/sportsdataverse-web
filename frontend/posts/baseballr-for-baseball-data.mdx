---
title: '{baseballr} for MLB, MiLB and NCAA Baseball'
date: '2021-12-10'
author:
  name: Saiem Gilani
  picture: '/blog/authors/saiemgilani.png'
tags: ['r', 'mlb', 'milb', 'ncaa', 'baseballr', 'sportsdataverse']
published: true
excerpt: 'An R package to quickly obtain clean and tidy baseball play by play data'
image: '/blog/baseballr-for-baseball-data/cover.png'
ogImage:
  url: '/blog/baseballr-for-baseball-data/cover.png'
---
