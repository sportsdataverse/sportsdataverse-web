...
published: true
excerpt: 'Sports data for the JavaScript and TypeScript ecosystem — play-by-play, box scores, schedules, standings, and rankings from ESPN, the NCAA website, and 247Sports across a dozen leagues.'
image: '/blog/sportsdataverse-node-js-module/cover.png'
ogImage:
  url: '/blog/sportsdataverse-node-js-module/cover.png'
---
